...
game_description mode =
  case mode of
    ...
    Numbers701 _ _ -> span []
      ...
      , p [] [ text "Variations:" ]
      , p [] [ text "Double In / Triple In : Requires double or triple hits during a turn in order to begin point deduction." ]
      , p [] [ text "Double Out / Triple Out : Requires double or triple hits during a turn in order to end the game. Busts happen on a turn score of 1 or 2 respectively." ]
      ]
    Numbers501 _ _ ->  span []
